...
class LocalPlanner():
    def __init__(self):
        ...
        self.debug_raw_pub = rospy.Publisher('arcturus_pilot/debug_raw', PointStamped, queue_size=5)
        self.debug_processed_pub = rospy.Publisher('arcturus_pilot/debug_processed', PointStamped, queue_size=5)
