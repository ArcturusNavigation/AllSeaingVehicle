...
class ColorSegmentationNode {
 ...
 public:
  ColorSegmentationNode(ros::NodeHandle n) : nh_(n) {
    img_sub_ = nh_.subscribe("/zed2i/zed_node/rgb/image_rect_color", 1,
                             &ColorSegmentationNode::imgCallback, this);
...
// TODO: Implement use of YoloV7 for object detection
...
int main(int argc, char** argv) {
  ...
  ros::NodeHandle nh;
  ColorSegmentationNode segmentation_node(nh);
  ros::spin();
  return 0;
}