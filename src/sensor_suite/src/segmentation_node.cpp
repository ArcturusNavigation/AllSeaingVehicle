...
class SegmentationClusterNode {
 ...
 public:
  SegmentationClusterNode(ros::NodeHandle n) : nh_(n), img_sub_(nh_, "/zed/rgb/image_rect_color", 1),
                                               depth_sub_(nh_, "/zed/depth/depth_registered", 1),
                                               info_sub_(nh_, "/zed/rgb/camera_info", 1)
                                               {
