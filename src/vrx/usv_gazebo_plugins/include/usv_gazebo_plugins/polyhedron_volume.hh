...
public:
  ...
  /// @return Volume object with volume and centroid
private:
  static Volume tetrahedronVolume(const ignition::math::Vector3d& v1, const ignition::math::Vector3d& v2,
...
private:
  static Volume clipTriangle(const ignition::math::Vector3d& v1, const ignition::math::Vector3d& v2,
