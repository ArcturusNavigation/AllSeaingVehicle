...
public:
  explicit Thruster(UsvThrust* _parent);
...
private:
  ...
  /// \return
private:
  double Glf(const double _x, const float _A, const float _K, const float _B, const float _v, const float _C,
