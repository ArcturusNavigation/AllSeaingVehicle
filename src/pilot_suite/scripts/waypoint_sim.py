...
class WaypointSim():
    def __init__(self):
        ...
        self.waypoint_sub = rospy.Subscriber('pilot_suite/processed_waypoint', ProcessedWaypoint, self.waypoint_callback)
        self.pose_pub = rospy.Publisher('pilot_suite/pose', PoseStamped, queue_size=10)
        ...
        self.waypoint_reached_pub = rospy.Publisher('pilot_suite/waypoint_reached', WaypointReached, queue_size=10)
